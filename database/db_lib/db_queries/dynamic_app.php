...
SELECT
  ...
  SUM(CASE WHEN baseline_not_idle = 1 THEN 1 ELSE 0 END) AS quiescent_fg_runs,
  SUM(CASE WHEN technical_validity_state = 'TECH_INVALID' THEN 1 ELSE 0 END) AS invalid_or_skipped_runs,
  SUM(CASE WHEN technical_validity_state = 'TECH_LEGACY_UNKNOWN' THEN 1 ELSE 0 END) AS unevaluated_historical_runs,
