...
SELECT
  ...
  latest_risk.permission_audit_grade AS grade,
  latest_risk.permission_audit_score_capped AS score_capped,
  latest_risk.permission_audit_dangerous_count AS dangerous_count,
  latest_risk.permission_audit_signature_count AS signature_count,
  latest_risk.permission_audit_vendor_count AS vendor_count,
  latest_risk.permission_audit_snapshot_key AS snapshot_key,
  latest_risk.permission_audit_created_at AS last_scanned,
  latest_risk.permission_audit_session_stamp AS latest_audit_session,
...
LEFT JOIN static_findings_summary summary
  ON summary.id = latest_static.summary_row_id
LEFT JOIN static_string_summary latest_strings
  ON latest_strings.package_name COLLATE utf8mb4_unicode_ci = latest_static.package_name COLLATE utf8mb4_unicode_ci
 AND latest_strings.session_stamp COLLATE utf8mb4_unicode_ci = latest_static.session_stamp COLLATE utf8mb4_unicode_ci
SQL;
...
LEFT JOIN (
  SELECT pa.static_run_id, pa.grade, pa.score_capped, pas.created_at AS audit_created_at
